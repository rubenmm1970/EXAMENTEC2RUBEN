...
<html>
    ...
    <body>
        ...
        <jsp:useBean id="miProducto" scope="request" class="com.emergentes.modelo.Produc_rMachaca" />
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="descripcion" 
                               value="<jsp:getProperty name="miProducto" property="descripcion" />">               
                    </td> 
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="categoria" 
                               value="<jsp:getProperty name="miProducto" property="categoria" />">               
                    </td> 
                </tr>   
                <tr>
                    <td>
